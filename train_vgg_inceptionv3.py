...
from tensorflow.keras.applications import InceptionV3 as IV
...
base_model = IV(include_top=False, weights='imagenet', input_shape=(img_size[0], img_size[1], channels))
...
model.save('chest_x-raysinceptionv3_15.h5')